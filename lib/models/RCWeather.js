...
class RCWeather {
  ...
  weathertoString() {
    return `
      ...
      Wind Velocity: ${this._parseWindString(this._getWindstring()).windVelocity
      } Km/h\n
      Wind Direction: ${this._parseWindString(this._getWindstring()).windDirection
      }\n
      Wind Direction Description: ${this._parseWindString(this._getWindstring()).windDirectionDesc
      }\n
      Wind Direction Degree: ${this._parseWindString(this._getWindstring()).windDegree
      }\n
      Wind Direction Radians: ${this._parseWindString(this._getWindstring()).windDirectionRadians
      }\n
  ...
  /**
   *
   * @description return info for the model weather by red.cuba.
   * @returns Object
   * @memberof RCWeather
   */
  weathertoOBJS() {
  ...
  /**
   *
   * @description parse WindString info
   * @param {*} windsString
   * @returns Object
   * @memberof RCWeather
   */
  ...
  /**
   *
   * @description parse wind velocity
   * @param {*} input
   * @returns Number
   * @memberof RCWeather
   */
  ...
  /**
   *
   * @description parse wind direction
   * @param {*} input
   * @returns String
   * @memberof RCWeather
   */
  ...
  /**
   *
   * @description parse wind radians
   * @param {*} degree
   * @returns Number
   * @memberof RCWeather
   */
